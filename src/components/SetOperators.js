...
export const SetOperators = (props) => {
    ...
    return (
            ...
            >
                <Draggable disabled={isdraggable ? false : true} handle='.handle' >
                    <Paper style={{zIndex: 11, width: '500px', backgroundColor: 'rgba(255, 255, 255, 1)'}}>
                        <DragIndicatorIcon /><h2 style={{cursor: 'grab'}} className='handle' >Set Operator Margins</h2>
                        <DonutChart data={fake_data}/>
                    </Paper> 
                </Draggable> 
            </motion.div>
    )
